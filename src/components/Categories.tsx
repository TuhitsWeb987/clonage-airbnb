...
export default function Categories() {
    ...
    return (
        <div className="relative pt-6 px-10 flex items-center gap-3">
                    ...
                    <div className="flex items-center">
                        {categoriesList.map((category, index) => (
                            <div key={index} className="w-32 flex-shrink-0">
                                <div className="flex flex-col items-center cursor-pointer border-[#fff] hover:border-b-2 hover:border-[#484848] pb-2">
            ...
            <button className="border border-[#000] flex items-center gap-1 rounded-md p-2 cursor-pointer">
